...
public class AdjustableIntegrationClock extends Clock {

    private final ZoneId zone;
    protected Instant instant;

    public AdjustableIntegrationClock(Instant initialInstant, ZoneId zone) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof AdjustableIntegrationClock other
